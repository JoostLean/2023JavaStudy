...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		-동일한 타입의 변수를 2개이상 선언하는 경우에는 컴마를 사용할 수 
			있다.
		-int형보다 작은 자료형을 연산하면 CPU는 int형으로 변환하여
			계산한다.
		-CPU는 정수의 연산인경우 int형에 최적화되어 있기 때문이다.
		-byte, short형은 게임캐릭터의 움직임이나 음원파일 등을 표현할때
			주로 사용된다. 
		*/
		...
		*/
		...
		이때 접미사(L 혹은 l)을 붙여서 int형의 자료가 아닌 long형의
		자료임을 컴파일러에게 알려줘야한다. 이와같이 할당을 위한 입력되는
		숫자도 자료형을 기반으로 메모리에 로드되는데 이를 가르켜
		리터럴(literal)이라고 한다. 
		*/
