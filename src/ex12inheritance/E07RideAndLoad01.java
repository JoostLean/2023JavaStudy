...
오버라이딩 : 메서드명, 매개변수, 반환타입까지 모두 동일한 메서드를
	...
	이 경우 하위클래스에서 증의한 메서드가 상위클래스의 메서드를 
...
public class E07RideAndLoad01 {
	...
	public static void main(String[] args) {
		...
		/* 기본자료형의 경우에는 작은타입이 큰타입에 할당되는것은 자동형변환
		이 되기때문에 아래와같이 작성할 수 있다.
		...
		//위의 문장이 가능하게 되려면 강제형변환을 하면 된다. (그 대신 손실을 감수)
		int d = (int) 3.14;
...
//////////////////////////////////////////////////////////////////////
		...
		//A -> C 참조하므로 가능
		A refId1 = new C();
		//B -> A(refId1)를 참조하므로 불가능(자식은 부모를 참조할 수 없다)
		//B refId2 = refId1;
