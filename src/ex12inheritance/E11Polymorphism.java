...
/*
다형성(Polymorphism)
: 하나의 인스턴스를 여러 타입의 참조변수를 통해 참조할때
...
class Child extends Parent {
	...
	/* 메서드명은 동일하지만 매개변수가 틀리므로 오버로딩으로 정의된 메소드.
	따라서 자식에서 확장한 멤버가 된다. */
...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		이 경우 자식클래스에서 새롭게 정의한 멤버는 접근할 수 없다.
		...
		*/
		...
		/*
		부모 참조변수로 접근하려면 강제형변환 해야한다. 하지만 아래와 같이
		기술하면 에러가 발생한다.
		...
		*/
		...
		Object클래스에 정의된 모든 메서드를 별도의 선언없이 사용할 수 
		있고, 필요하다면 오버라이딩도 할수있다. 
		*/
