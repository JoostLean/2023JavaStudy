...
class Account {
	...
	선언하면 된다. 이 경우 가독성을 위해 숫자 사이에 _(언더바)를 사용하는 것이
	허용된다. 단, 정수타입이므로 작성시 "(더블쿼테이션)은 제거해야한다. */
	long accountNumber;
...
public class E04AccountMain {
	...
	public static void main(String[] args) {
		...
		/* 멤버변수를 직접 기술하는것은 초기화메서드에 비해 불편한 방법
		이므로 첫번째 방법으로 초기화하는 것이 좋다. */
