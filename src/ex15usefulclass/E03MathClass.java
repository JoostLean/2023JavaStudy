...
/*
Java의 규칙 : java.lang 패키지 하위의 모든 클래스는 자동으로 import
	된다. 또한 정의하는 모든 클래스는 Object를 상속받게 되어있다.
...
public class E03MathClass extends Object {
	...
	*/
	public static void main(String[] args) {
		...
		x.5 이상이면 올림처리, x.5 미만이면 버림처리를 한다.
		따라서 3.4xxxx라면 버림처리를 하게 된다. 
		*/
		...
		System.out.println("Math.round:"+ Math.round(-1.5));//-2
		...
		/*
		0~1사이의 실수를 랜덤하게 반환한다. 따라서 정수값을 만들때는
		특정 수를 곱한 후 정수로 형변환하면 된다. 
		*/
