...
public class E06LocalDateTime {
	...
	public static void main(String[] args) {
		...
		/*
		Period클래스 : 두 날짜 사이의 간격을 나타낸다. ?개월 ?일
			남음으로 표시할 수 있다.
		*/
		...
		*/
		...
		System.out.println("5일전 : "+ moment.minusDays(5));//5일전
		System.out.println("3일후 : "+ moment.plusDays(3));//3일후
		System.out.println("2개월후 : "+ moment.plusMonths(2));//2개월후
		System.out.println("1년후 : "+ moment.plusYears(1));//1년후
