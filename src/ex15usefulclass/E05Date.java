...
public class E05Date {
	/*
	Calendar 클래스를 통해 얻은 인스턴스를 초 단위로 변환 후 매개변수로
	전달된 날짜서식으로 변경한 문자열을 반환한다. 
	*/
	public static String myDateFormat(Calendar c, String formatStr) {
		/*
		getTime() : 서버의 표준시인 1970-01-01부터 현재까지의 시간을
		초 단위로 반환해준다. 이를 타임스탬프 라고 한다. 
		*/
		Date date = c.getTime();
	...
	public static void main(String[] args) {
		...
		/*
		Calendar 클래스는 대표적인 싱글폰 클래스이므로 new로 인스턴스를
