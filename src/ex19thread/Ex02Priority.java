...
public class Ex02Priority {
	...
	public static void main(String[] args) {
		...
		1단계실행 : 우선순위를 부여하지 않은 상태로 쓰레드 인스턴스를
			실행하면 동일한 우선순위 5을 부여받게 된다. 이때는 CPU가
			알아서 작업을 분배한다.
		*/
...
//		MessageSendingThread tr3 = new MessageSendingThread("세번째");
		...
		/*
		2단계실행 : 오버로딩하여 정의한 생성자를 통해 우선순위를 부여한
			상태로 인스턴스를 생성한다. Thread클래스에 정적상수를 통해
			10, 5, 1의 우선순위를 부여할 수 있다. (1~10까지만 가능)
			상수 대신 정수로 부여해도 된다.
		*/
