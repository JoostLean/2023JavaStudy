...
public class E05For {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Variable)라고 한다. 지역변수는 해당 지역(블럭)을 벗어나면
		메모리에서 소멸되는 특징을 가지고있다. 
		*/
		//변수 j는 for문이 종료될때 소멸되므로 아래는 에러가 발생된다.
		//System.out.println("위 for문에서 선언한 변수 j="+ j);
		System.out.println("위 main함수 지역에서 선언한 변수 "
				+ "total="+ total);
		
		/*
		for문의 초기값을 외부(넓은지역, 여기서는 main지역)에서 선언하면
		...
		*/
		...
		즉 if문, while문 등의 제어문도 하나의 지역을 가지게된다. */
